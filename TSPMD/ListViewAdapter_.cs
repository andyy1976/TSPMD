...
namespace TSPMD
{
    ...
    /// Files fragment
    /// </summary>
    class ListViewAdapter_ : BaseAdapter<Information>
    {
        private List<Information> items_;
        private Context context_;
        private Files filesActivity_;
        private Android.Media.MediaPlayer mp;
        private Handler mpHandler;
        private Action mpAction;

        public ListViewAdapter_(Context context, List<Information> items, Files filesActivity)
        {
            items_ = items;
            context_ = context;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (row == null)
            {
                row = LayoutInflater.From(context_).Inflate(Resource.Layout.Row_, null, false);
            }
